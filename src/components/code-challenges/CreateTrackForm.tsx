// src/components/code-challenges/CreateTrackForm.tsx
...
import type { CreateTrackFormData, ProgrammingLanguage, DifficultyLevel, TrackCategory } from '../../types';
...
const CreateTrackForm: React.FC<CreateTrackFormProps> = ({
  ...
  const { createCodeTrack } = useCodeChallenge();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createCodeTrack(formData);
    ...
    <Card>
      <CardHeader>
        <div className="d-flex align-items-center">
          ...
          <h5 className="mb-0">Create New Track</h5>
        </div>
      </CardHeader>
      <CardBody>
        {error && (
